...
output "log_groups_credo" {
  value = aws_cloudwatch_log_group.log_groups_credo_service.name
}

output "log_groups_seed" {
  value = aws_cloudwatch_log_group.log_groups_seed_service.name
}